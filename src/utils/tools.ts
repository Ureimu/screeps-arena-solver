...
export const negBodyAbbreviation: { [name: string]: string } = {
    move: "m",
    work: "w",
    carry: "c",
    attack: "a",
...
export class bodyTools {
     ...
     *
     * @static
     * @param {BodyPartConstant[]} partList
     * @returns {string}
     * @memberof bodyTools
     */
    public static getBodyStr(partList: BodyPartConstant[]): string {
        return partList.reduce((str, part) => {
            return str.concat(negBodyAbbreviation[part]);
        }, "");
    }
}
